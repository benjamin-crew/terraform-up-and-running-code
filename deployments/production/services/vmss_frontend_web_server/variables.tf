...
variable "vmss_subnet_name" {
  type    = string
  default = "bc-uks-prd-tfupandrunning-sb01"
}
...
variable "vmss_name" {
  type    = string
  default = "bc-uks-prd-tfupandrunning-vmss-01"
}
...
variable "pip_name" {
  type    = string
  default = "bc-uks-prd-tfupandrunning-pip-01"
}

variable "vmss_lb_name" {
  type    = string
  default = "bc-uks-prd-tfupandrunning-vmss-lb-01"
}
